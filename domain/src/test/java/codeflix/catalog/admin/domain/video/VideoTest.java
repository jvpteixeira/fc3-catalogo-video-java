...
class VideoTest extends UnitTest {
    ...
    void givenValidParams_whenCallsNewVideo_shouldInstantiate() {
        ...
        final Set<CategoryID> expectedCategories = Set.of(CategoryID.unique());
        final Set<GenreID> expectedGenres = Set.of(GenreID.unique());
        final Set<CastMemberID> expectedMembers = Set.of(CastMemberID.unique());

        //when
        final Video actualVideo = Video.newVideo(
                expectedTitle,
                expectedDescription,
                expectedLaunchedAt,
                expectedDuration,
    ...
    void givenValidVideo_whenCallsUpdateVideoMedia_shouldReturnUpdated() {
        ...
        final var expectedGenres = Set.of(GenreID.unique());
        final var expectedMembers = Set.of(CastMemberID.unique());
        final var expectedDomainEventsCounter = 1;
        ...
        Assertions.assertTrue(actualVideo.getThumbnail().isEmpty());
        Assertions.assertTrue(actualVideo.getThumbnailHalf().isEmpty());
        Assertions.assertEquals(expectedDomainEventsCounter, actualVideo.getDomainEvents().size());

        final VideoMediaCreated actualEvent = (VideoMediaCreated) actualVideo.getDomainEvents().get(0);
    ...
    @Test
    void givenValidVideo_whenCallsWith_shouldCreateWithoutEvent() {
        // given
        final var expectedTitle = "System Design Interviews";
        final var expectedDescription = """
                Disclaimer: o estudo de caso apresentado tem fins educacionais e representa nossas opiniões pessoais.
