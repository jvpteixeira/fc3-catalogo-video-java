package codeflix.catalog.admin.e2e.category;
...
class CategoryE2ETest implements MockDsl {
    ...
    @Test
    void asACatalogAdminIShouldBeAbleToCreateACategoryWithValidValues() throws Exception {
        ...
        final CategoryID expectedId = givenACategory(expectedName, expectedDescription, expectedIsActive);

        final CategoryResponse actualCategory = retrieveACategory(expectedId);
    ...
    void asACatalogAdminIShouldBeAbleToGetACategoryByItsIdentifier() throws Exception {
        ...
        final CategoryResponse actualCategory = retrieveACategory(actualId);
